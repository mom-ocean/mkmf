...
# make <file>.x		create an executable file, assuming standalone source
...
$(info FPPFLAGS is $(FPPFLAGS))
$(info FFLAGS is $(FFLAGS))
$(info OTHERFLAGS is $(OTHERFLAGS))
$(info OTHER_CFLAGS is $(OTHER_CFLAGS))
